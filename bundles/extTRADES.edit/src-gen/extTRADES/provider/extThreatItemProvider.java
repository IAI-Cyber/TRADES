...
import dsm.TRADES.provider.ThreatItemProvider;
...
/**
 * This is the item provider adapter for a {@link extTRADES.extThreat} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class extThreatItemProvider extends ThreatItemProvider {
	/**
	 ...
	 * @generated
	 */
	public extThreatItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/extThreat"));
	}
	...
	public String getText(Object object) {
		String label = ((extThreat) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_extThreat_type")
				: getString("_UI_extThreat_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(extThreat.class)) {
