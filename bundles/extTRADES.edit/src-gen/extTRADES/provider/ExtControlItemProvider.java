...
import dsm.TRADES.provider.ControlItemProvider;
...
/**
 * This is the item provider adapter for a {@link extTRADES.ExtControl} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExtControlItemProvider extends ControlItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ExtControlItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExtControl"));
	}
	...
	public String getText(Object object) {
		String label = ((ExtControl) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_ExtControl_type")
				: getString("_UI_ExtControl_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ExtControl.class)) {
		case ExtTRADESPackage.EXT_CONTROL__SOURCE:
		case ExtTRADESPackage.EXT_CONTROL__LINK:
