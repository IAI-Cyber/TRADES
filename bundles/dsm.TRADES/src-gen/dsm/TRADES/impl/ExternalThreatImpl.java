...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>External Threat</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class ExternalThreatImpl extends ThreatCustomImpl implements ExternalThreat {
	...
	protected EClass eStaticClass() {
		return TRADESPackage.Literals.EXTERNAL_THREAT;
	}
	...
	public void setSource(String newSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TRADESPackage.EXTERNAL_THREAT__SOURCE, oldSource,
					source));
	}
	...
	public void setLink(String newLink) {
		...
		link = newLink;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TRADESPackage.EXTERNAL_THREAT__LINK, oldLink, link));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ExternalElement.class) {
