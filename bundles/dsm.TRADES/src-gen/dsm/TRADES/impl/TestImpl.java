 ...
 * </p>
 * <ul>
 *   <li>{@link dsm.TRADES.impl.TestImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link dsm.TRADES.impl.TestImpl#getRemark <em>Remark</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestImpl extends MinimalEObjectImpl.Container implements Test {
	...
	protected EClass eStaticClass() {
		return TRADESPackage.Literals.TEST;
	}
	...
	public void setExpression(String newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TRADESPackage.TEST__EXPRESSION, oldExpression,
					expression));
	}
	...
	public void setRemark(String newRemark) {
		...
		remark = newRemark;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TRADESPackage.TEST__REMARK, oldRemark, remark));
	}
