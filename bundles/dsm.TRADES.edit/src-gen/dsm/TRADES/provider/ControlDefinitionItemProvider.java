...
/**
 * This is the item provider adapter for a {@link dsm.TRADES.ControlDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ControlDefinitionItemProvider extends PropertyOwnerItemProvider {
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						TRADESPackage.Literals.CONTROL_DEFINITION__ID, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ControlDefinition_title_feature",
								"_UI_ControlDefinition_type"),
						TRADESPackage.Literals.CONTROL_DEFINITION__TITLE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TRADESPackage.Literals.CONTROL_DEFINITION__PARTS);
			childrenFeatures.add(TRADESPackage.Literals.CONTROL_DEFINITION__OSCALCONTROLS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(TRADESPackage.Literals.CONTROL_DEFINITION__PARTS,
				TRADESFactory.eINSTANCE.createPartition()));

		newChildDescriptors.add(createChildParameter(TRADESPackage.Literals.CONTROL_DEFINITION__OSCALCONTROLS,
