...
/**
 * This is the item provider adapter for a {@link dsm.TRADES.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Constraint_description_feature",
								"_UI_Constraint_type"),
						TRADESPackage.Literals.CONSTRAINT__DESCRIPTION, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TRADESPackage.Literals.CONSTRAINT__TESTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(TRADESPackage.Literals.CONSTRAINT__TESTS, TRADESFactory.eINSTANCE.createTest()));
	}
