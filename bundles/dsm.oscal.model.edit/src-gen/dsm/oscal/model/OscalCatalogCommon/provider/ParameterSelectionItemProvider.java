...
public class ParameterSelectionItemProvider 
	 ...
	 * @generated
	 */
	public ParameterSelectionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ParameterSelection_howMany_feature", "_UI_ParameterSelection_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ParameterSelection_choice_feature", "_UI_ParameterSelection_type"),
	...
	/**
	 * This returns ParameterSelection.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ParameterSelection"));
	}
	...
	public String getText(Object object) {
		String label = ((ParameterSelection)object).getHowMany();
		return label == null || label.length() == 0 ?
			getString("_UI_ParameterSelection_type") :
			getString("_UI_ParameterSelection_type") + " " + label;
	}
