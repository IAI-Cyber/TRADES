...
/**
 * This is the item provider adapter for a {@link dsm.oscal.model.Oscal.Include} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IncludeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OscalPackage.Literals.INCLUDE__ALL);
			childrenFeatures.add(OscalPackage.Literals.INCLUDE__CALLS);
			childrenFeatures.add(OscalPackage.Literals.INCLUDE__MATCHS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(OscalPackage.Literals.INCLUDE__ALL, OscalFactory.eINSTANCE.createAll()));

		newChildDescriptors
				.add(createChildParameter(OscalPackage.Literals.INCLUDE__CALLS, OscalFactory.eINSTANCE.createCall()));

		newChildDescriptors
				.add(createChildParameter(OscalPackage.Literals.INCLUDE__MATCHS, OscalFactory.eINSTANCE.createMatch()));
	}
