...
/**
 * This is the item provider adapter for a {@link dsm.oscal.model.Oscal.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Constraint_description_feature",
								"_UI_Constraint_type"),
						OscalPackage.Literals.CONSTRAINT__DESCRIPTION, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OscalPackage.Literals.CONSTRAINT__TESTS);
		}
	...
	public String getText(Object object) {
		String label = ((Constraint) object).getDescription();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(OscalPackage.Literals.CONSTRAINT__TESTS, OscalFactory.eINSTANCE.createTest()));
	}
