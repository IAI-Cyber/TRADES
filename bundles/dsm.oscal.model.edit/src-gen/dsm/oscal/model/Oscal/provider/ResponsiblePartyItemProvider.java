...
/**
 * This is the item provider adapter for a {@link dsm.oscal.model.Oscal.ResponsibleParty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResponsiblePartyItemProvider extends PropertyOwnerItemProvider {
	...
	protected void addRoleIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						OscalPackage.Literals.RESPONSIBLE_PARTY__ROLE_ID, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ResponsibleParty_partyUuid_feature",
								"_UI_ResponsibleParty_type"),
						OscalPackage.Literals.RESPONSIBLE_PARTY__PARTY_UUID, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OscalPackage.Literals.RESPONSIBLE_PARTY__REMARK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(OscalPackage.Literals.RESPONSIBLE_PARTY__REMARK,
				OscalFactory.eINSTANCE.createRemark()));
	}
