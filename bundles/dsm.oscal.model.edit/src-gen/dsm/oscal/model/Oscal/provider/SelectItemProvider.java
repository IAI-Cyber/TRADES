...
/**
 * This is the item provider adapter for a {@link dsm.oscal.model.Oscal.Select} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SelectItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addHowManyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Select_howMany_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Select_howMany_feature",
								"_UI_Select_type"),
						OscalPackage.Literals.SELECT__HOW_MANY, true, false, false,
	...
	protected void addChoicePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Select_choice_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Select_choice_feature", "_UI_Select_type"),
						OscalPackage.Literals.SELECT__CHOICE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((Select) object).getHowMany();
		return label == null || label.length() == 0 ? getString("_UI_Select_type")
