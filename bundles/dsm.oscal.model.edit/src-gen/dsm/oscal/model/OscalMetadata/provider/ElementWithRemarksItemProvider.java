 ...
 * @generated
 */
public class ElementWithRemarksItemProvider 
	 ...
	 * @generated
	 */
	public ElementWithRemarksItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns ElementWithRemarks.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ElementWithRemarks"));
	}
	...
	public String getText(Object object) {
		MarkupMultiline labelValue = ((ElementWithRemarks)object).getRemarks();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ElementWithRemarks_type") :
			getString("_UI_ElementWithRemarks_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ElementWithRemarks.class)) {
			case OscalMetadataPackage.ELEMENT_WITH_REMARKS__REMARKS:
