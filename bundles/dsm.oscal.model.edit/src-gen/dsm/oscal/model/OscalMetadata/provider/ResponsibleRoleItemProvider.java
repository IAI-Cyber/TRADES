...
public class ResponsibleRoleItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ResponsibleRole_roleId_feature", "_UI_ResponsibleRole_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ResponsibleRole_partyUuids_feature", "_UI_ResponsibleRole_type"),
	...
	protected void addRemarksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResponsibleRole_remarks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResponsibleRole_remarks_feature", "_UI_ResponsibleRole_type"),
				 OscalMetadataPackage.Literals.RESPONSIBLE_ROLE__REMARKS,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ResponsibleRole)object).getRoleId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OscalMetadataPackage.Literals.RESPONSIBLE_ROLE__LINKS,
				 OscalMetadataFactory.eINSTANCE.createLink()));

		newChildDescriptors.add
			(createChildParameter
				(OscalMetadataPackage.Literals.RESPONSIBLE_ROLE__PROPS,
