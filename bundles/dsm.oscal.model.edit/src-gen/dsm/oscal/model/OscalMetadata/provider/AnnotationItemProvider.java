...
/**
 * This is the item provider adapter for a {@link dsm.oscal.model.OscalMetadata.Annotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OscalMetadataPackage.Literals.ANNOTATION__NAME,
				 true,
				 false,
				 false,
	...
	protected void addNsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Annotation_ns_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Annotation_ns_feature", "_UI_Annotation_type"),
				 OscalMetadataPackage.Literals.ANNOTATION__NS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
