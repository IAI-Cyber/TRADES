...
public class ExtMarkdownDescriptionItemProvider extends WidgetDescriptionItemProvider {
    ...
    protected void addValueExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ExtMarkdownDescription_valueExpression_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_ExtMarkdownDescription_valueExpression_feature", "_UI_ExtMarkdownDescription_type"),
    ...
    protected void addNumberOfLinesPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_ExtMarkdownDescription_numberOfLines_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ExtMarkdownDescription_numberOfLines_feature", "_UI_ExtMarkdownDescription_type"),
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/ExtMarkdownDescription"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ExtMarkdownDescription_type") : getString("_UI_ExtMarkdownDescription_type") + " " + label;
    }
