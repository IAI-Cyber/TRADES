...
public class Services {
    ...
    */
    ...
    public void encapsulateElements(Component component, DDiagram diagram) {
    	Collection<EObject> result = new EObjectQuery(component).getInverseReferences(ViewpointPackage.Literals.DREPRESENTATION_ELEMENT__SEMANTIC_ELEMENTS);
    	//???result.toArray();
    ...
    public void decapsulateElements(Component component, DDiagram diagram) {
    	Collection<EObject> result = new EObjectQuery(component).getInverseReferences(ViewpointPackage.Literals.DREPRESENTATION_ELEMENT__SEMANTIC_ELEMENTS); //past: DSEMANTIC_DECORATOR__TARGET
    	//DSemanticDecor
