 ...
 * </p>
 * <ul>
 *   <li>{@link dsm.oscal.model.Oscal.impl.LinkImpl#getHref <em>Href</em>}</li>
 *   <li>{@link dsm.oscal.model.Oscal.impl.LinkImpl#getRel <em>Rel</em>}</li>
 *   <li>{@link dsm.oscal.model.Oscal.impl.LinkImpl#getMediaType <em>Media Type</em>}</li>
 *   <li>{@link dsm.oscal.model.Oscal.impl.LinkImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinkImpl extends MinimalEObjectImpl.Container implements Link {
	...
	protected EClass eStaticClass() {
		return OscalPackage.Literals.LINK;
	}
	...
	public void setMediaType(String newMediaType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OscalPackage.LINK__MEDIA_TYPE, oldMediaType,
					mediaType));
	}
