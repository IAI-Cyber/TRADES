...
public class HashImpl extends MinimalEObjectImpl.Container implements Hash {
	...
	protected EClass eStaticClass() {
		return OscalMetadataPackage.Literals.HASH;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OscalMetadataPackage.HASH__VALUE, oldValue, value));
	}
	...
	public void setAlgorithm(String newAlgorithm) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OscalMetadataPackage.HASH__ALGORITHM, oldAlgorithm, algorithm));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ElementWithValue.class) {
			switch (derivedFeatureID) {
				case OscalMetadataPackage.HASH__VALUE: return OscalMetadataPackage.ELEMENT_WITH_VALUE__VALUE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ElementWithValue.class) {
			switch (baseFeatureID) {
				case OscalMetadataPackage.ELEMENT_WITH_VALUE__VALUE: return OscalMetadataPackage.HASH__VALUE;
				default: return -1;
			}
		}
