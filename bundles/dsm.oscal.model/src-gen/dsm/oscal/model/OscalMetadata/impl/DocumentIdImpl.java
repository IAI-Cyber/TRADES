 ...
 * @generated
 */
public class DocumentIdImpl extends OscalElementCustomImpl implements DocumentId {
	/**
	...
	protected EClass eStaticClass() {
		return OscalMetadataPackage.Literals.DOCUMENT_ID;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OscalMetadataPackage.DOCUMENT_ID__VALUE, oldValue, value));
	}
	...
	public void setScheme(URI newScheme) {
		...
		scheme = newScheme;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OscalMetadataPackage.DOCUMENT_ID__SCHEME, oldScheme, scheme));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ElementWithValue.class) {
			switch (derivedFeatureID) {
				case OscalMetadataPackage.DOCUMENT_ID__VALUE: return OscalMetadataPackage.ELEMENT_WITH_VALUE__VALUE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ElementWithValue.class) {
			switch (baseFeatureID) {
				case OscalMetadataPackage.ELEMENT_WITH_VALUE__VALUE: return OscalMetadataPackage.DOCUMENT_ID__VALUE;
				default: return -1;
			}
		}
