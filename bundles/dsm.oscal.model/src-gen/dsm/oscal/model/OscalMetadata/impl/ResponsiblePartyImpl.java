 ...
 * @generated
 */
public class ResponsiblePartyImpl extends OscalElementCustomImpl implements ResponsibleParty {
	/**
	...
	protected EClass eStaticClass() {
		return OscalMetadataPackage.Literals.RESPONSIBLE_PARTY;
	}
	...
	public void setRoleId(String newRoleId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OscalMetadataPackage.RESPONSIBLE_PARTY__ROLE_ID, oldRoleId, roleId));
	}
	...
	public EList<UUID> getPartyUuids() {
		if (partyUuids == null) {
			partyUuids = new EDataTypeUniqueEList<UUID>(UUID.class, this, OscalMetadataPackage.RESPONSIBLE_PARTY__PARTY_UUIDS);
		}
		return partyUuids;
	}
	...
	public void setRemarks(MarkupMultiline newRemarks) {
		...
		remarks = newRemarks;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OscalMetadataPackage.RESPONSIBLE_PARTY__REMARKS, oldRemarks, remarks));
	}
	...
	public EList<Link> getLinks() {
		if (links == null) {
			links = new EObjectContainmentEList<Link>(Link.class, this, OscalMetadataPackage.RESPONSIBLE_PARTY__LINKS);
		}
		return links;
	}
	...
	public EList<Property> getProps() {
		if (props == null) {
			props = new EObjectContainmentEList<Property>(Property.class, this, OscalMetadataPackage.RESPONSIBLE_PARTY__PROPS);
		}
		return props;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == PropertyOwner.class) {
			switch (derivedFeatureID) {
				case OscalMetadataPackage.RESPONSIBLE_PARTY__PROPS: return OscalMetadataPackage.PROPERTY_OWNER__PROPS;
				default: return -1;
			}
		}
		if (baseClass == LinkOwner.class) {
			switch (derivedFeatureID) {
				case OscalMetadataPackage.RESPONSIBLE_PARTY__LINKS: return OscalMetadataPackage.LINK_OWNER__LINKS;
				default: return -1;
			}
		}
		if (baseClass == ElementWithRemarks.class) {
			switch (derivedFeatureID) {
				case OscalMetadataPackage.RESPONSIBLE_PARTY__REMARKS: return OscalMetadataPackage.ELEMENT_WITH_REMARKS__REMARKS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == PropertyOwner.class) {
			switch (baseFeatureID) {
				case OscalMetadataPackage.PROPERTY_OWNER__PROPS: return OscalMetadataPackage.RESPONSIBLE_PARTY__PROPS;
				default: return -1;
			}
		}
		if (baseClass == LinkOwner.class) {
			switch (baseFeatureID) {
				case OscalMetadataPackage.LINK_OWNER__LINKS: return OscalMetadataPackage.RESPONSIBLE_PARTY__LINKS;
				default: return -1;
			}
		}
		if (baseClass == ElementWithRemarks.class) {
			switch (baseFeatureID) {
				case OscalMetadataPackage.ELEMENT_WITH_REMARKS__REMARKS: return OscalMetadataPackage.RESPONSIBLE_PARTY__REMARKS;
				default: return -1;
			}
		}
